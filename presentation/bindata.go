...
func templatesShowerHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/shower.html", size: 749, mode: os.FileMode(420), modTime: time.Unix(1450172087, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
